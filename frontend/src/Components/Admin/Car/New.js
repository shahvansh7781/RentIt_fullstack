      ...
      <div className='car-content-div'>
        ...
        <div className='create-info-div'>
          ...
          <div className='new-car-feat-data'>
                ...
                <select value={myCar} onChange={handleChange} className="car-company-option">

                  <option className='car-company' value="company">Company</option>
                  <option className='car-company' value="tata">Tata</option>
                  <option className='car-company' value="hyundia">Hyundia</option>
                  <option className='car-company' value="maruti_suzuki">Maruti Suzuki</option>
                  <option className='car-company' value="toyota">Toyota</option>
                  <option className='car-company' value="mahindra">Mahindra</option> 
