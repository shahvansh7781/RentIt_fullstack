...
const Contact = () => {
  ...
  const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_p4es96r','template_l5jc2jf',e.target,'Y5EiWZzcTKeqDVo0F') 
    ...
    <div className = "contact-body">
      <div className = "contact-info">
        ...
        <div>
          ...
          <span>E-mail</span>
          <span className = "text"><a className="fas-mail"href="mailto:rentit7.com@gmail.com">rentit7.com@gmail.com</a></span>
        </div>
